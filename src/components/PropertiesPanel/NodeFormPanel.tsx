...
export const NodeFormPanel = () => {
    ...
    <>
      ...
      <div className="form-group">
        ...
        <input 
          ...
          value={(selectedNode.data as any).autoApproveThreshold || 0} 
          onChange={handleChange} 
        />
      </div>
    </>
  ...
  const renderAutomatedStepNodeForm = () => {
    const selectedAction = actions.find(a => a.id === (selectedNode.data as any).actionId);
    return (
      <>
        <div className="form-group">
          <label>Title</label>
        ...
        <div className="form-group">
          ...
          <select 
            name="actionId" 
            value={(selectedNode.data as any).actionId || ''} 
            onChange={handleChange}
          >
        ...
        {selectedAction && selectedAction.params.length > 0 && (
          <div className="form-section">
            ...
            {selectedAction.params.map(param => {
              const currentParams = (selectedNode.data as any).actionParams || {};
              return (
